...
const setbuttonShowClickEvent = (buttonShow, devices) => {
  buttonShow.addEventListener("click", () => {
    console.log("SHOW CLICK");
    if (window.classActivated) {
      const mic = citbMicrophone(
        devices,
        "audioinput",
        MYAUDIODEVICELABEL,
        compare.iqual
...
const setbuttonClassClickEvent = (buttonClass, devices) => {
  buttonClass.addEventListener("click", () => {
    console.log("CLASS CLICK");
    if (window.classActivated) {
      const citbMicrophone = citbMicrophone(
        devices,
        "audioinput",
        MYAUDIODEVICELABEL,
        compare.iqual
      ...
      // );
      const otherMicrophones = citbMicrophone(
        devices,
        "audioinput",
        MYAUDIODEVICELABEL,
        compare.distinct
...
function elementDrag(e) {
  ...
  window.buttonsContainerDiv.style.top =
    window.buttonsContainerDiv.offsetTop - pos2 + "px";
  window.buttonsContainerDiv.style.left =
    window.buttonsContainerDiv.offsetLeft - pos1 + "px";
}
