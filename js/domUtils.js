...
const getButtonShow = () => {
    ...
    buttonClose.setAttribute('id', 'buttonShow');
...
const getButtonClass = () => {
    ...
    buttonClose.setAttribute('id', 'buttonClass');
...
const getButtonCam = () => {
    ...
    buttonClose.setAttribute('id', 'buttonCam');
...
const getButtonDrag = () => {
  ...
  const setButtonCamBackground = (activated) => {
    document.getElementById('buttonCam').style.backgroundImage = activated 
  ...
  const setButtonShowBackground = (activated) => {
    document.getElementById('buttonShow').style.background = activated 
    ...
    document.getElementById('buttonShow').style.backgroundSize = '60px 60px !important';
    document.getElementById('buttonShow').style.backgroundRepeat = 'no-repeat';
    document.getElementById('buttonShow').style.backgroundPosition = 'center';
  }

  const setButtonClassBackground = (activated) => {
    document.getElementById('buttonClass').style.background = activated 
