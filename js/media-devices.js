  ...
  if (window.location.host === 'meet.google.com') {
    ...
    document.onreadystatechange = (event) => {
      ...
      const setButtonCamBackground = (activated) => {
        buttonCam.style.backgroundImage = activated 
        ...
        buttonCam.style.backgroundSize = '60px 60px !important';
        buttonCam.style.backgroundRepeat = 'no-repeat';
        buttonCam.style.backgroundPosition = 'center';
      }
      ...
      const setButtonShowBackground = (activated) => {
        ...
        buttonShow.style.backgroundSize = '60px 60px !important';
        buttonShow.style.backgroundRepeat = 'no-repeat';
        buttonShow.style.backgroundPosition = 'center';
      }
      ...
      const setButtonClassBackground = (activated) => {
        ...
        buttonClass.style.backgroundSize = '60px 60px !important';
        buttonClass.style.backgroundRepeat = 'no-repeat';
        buttonClass.style.backgroundPosition = 'center';
      }
